...
const Employee=React.lazy(() => import('./views/employee/addEmployee'))
...
const routes = [
  ...
  { path: '/employee', name: 'Employee', component: Employee, exact: true },
  { path: '/employee/add', name: 'Employee', component: Employee },
]
